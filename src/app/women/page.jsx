...
const WomenPage = () => (
  <div className="bg-gray-100 font-sans mx-4">
    <main>
      ...
      <CategoryGrid apiUrl={WomEN_API} start="14" end="20" gender="women" />
      <Carousel apiUrl={WomEN_API} sectionTitle="Women" gender="women" />
      <ShopByCategory apiUrl={WomEN_API} gender="women" />
    </main>
  </div>
);
