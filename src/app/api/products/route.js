...
export async function GET(request) {
  try {
    ...
    const showInKidsCategories = searchParams.get("showInKidsCategories");
    const showInIconicBrands = searchParams.get("showInIconicBrands");
    const showInFavouriteBrands = searchParams.get("showInFavouriteBrands");
    const showInExploreMore = searchParams.get("showInExploreMore");
    ...
    if (showInBrowseCategories)
      query.showInBrowseCategories = showInBrowseCategories === "true";
    if (showInShopByCategory)
      query.showInShopByCategory = showInShopByCategory === "true";
    if (showInKidsCategories)
      query.showInKidsCategories = showInKidsCategories === "true";
    if (showInIconicBrands)
      query.showInIconicBrands = showInIconicBrands === "true";
    if (showInFavouriteBrands)
      query.showInFavouriteBrands = showInFavouriteBrands === "true";
...
export async function POST(request) {
  try {
    ...
    const productData = {
      ...
      showInKidsCategories: formData.get("showInKidsCategories") === "true",
      showInIconicBrands: formData.get("showInIconicBrands") === "true",
      showInFavouriteBrands: formData.get("showInFavouriteBrands") === "true",
      showInExploreMore: formData.get("showInExploreMore") === "true",
      createdAt: new Date(),
    };
  ...
  try {
    ...
    fields.forEach((field) => {
      ...
      if (value !== null) {
        ...
        } else if (field.startsWith("showIn") || field === "featured") {
