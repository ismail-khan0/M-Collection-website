  ...
  return (
    <div>
      ...
      <div className="relative mx-4 mt-8">
              ...
              >
                <div className="relative w-full h-56 rounded-xl overflow-hidden shadow-md group">
                  <Image
                    ...
                    alt={product.title}
                    fill
                    className="object-contain bg-white transition-all duration-700 ease-in-out group-hover:scale-105"
                  />
                </div>
        ...
        <button
          onClick={scrollPrev}
          className="absolute left-0 top-1/2 transform -translate-y-1/2 z-10 bg-white/70 hover:bg-white rounded-full p-2"
        >
        ...
        <button
          onClick={scrollNext}
          className="absolute right-0 top-1/2 transform -translate-y-1/2 z-10 bg-white/70 hover:bg-white rounded-full p-2"
        >
          <svg className="w-4 h-4 text-black" viewBox="0 0 6 10">
            <path
              d="m1 9 4-4-4-4"
